            ...
            <asp:GridView ID="grdOrders" runat="server" AutoGenerateColumns="false" DataKeyNames="TempOrderID"
                ...
                <Columns>
                    ...
                    <asp:TemplateField SortExpression="PRONO" HeaderText="Petition/RA No" HeaderStyle-CssClass="Text-Center">
                        <ItemTemplate>
                         <asp:Label ID="lbldate" visible="false" runat="server" Text='<%#Eval("OrderDate")%>'>
                            </asp:Label>
                            <asp:Label ID="lblPetition" runat="server" Text='<%#Eval("PRONO")%>'>
                            </asp:Label>
                            <asp:Label ID="lblReview" runat="server" Text='<%#Eval("Review")%>' Visible="false">
                    ...
                    <asp:TemplateField ItemStyle-CssClass="Text-Center" HeaderStyle-CssClass="Text-Center">
                        ...
                        <ItemTemplate>
                            <a href="Order_Edit.aspx?orderID=<%#DataBinder.Eval(Container.DataItem,"TempOrderID")%> &ModuleID= <%=Convert.ToInt16( Module_ID_Enum.Project_Module_ID.Orders) %>&LangID=<%#DataBinder.Eval(Container.DataItem,"Lang_Id")%>&Connection=<%#DataBinder.Eval(Container.DataItem,"ConnectionID")%>&Status=<%#ddlStatus.SelectedValue %>">
