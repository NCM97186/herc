<%@ Page Language="C#" MasterPageFile="~/Auth/AdminPanel/AdminMasterPage.master"
    AutoEventWireup="true" CodeFile="ProfileDisplay.aspx.cs" Inherits="Auth_AdminPanel_ProfileManagement_ProfileDisplay" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel ID="pnlGrid" runat="server">
        <p style="float: right">
            ...
            <asp:Button ID="btnAddProfile" runat="server" CssClass="button" Text="New Profile"
                OnClick="btnAddProfile_Click" ToolTip="Add New Profile" />
        </p>
        ...
        <p id="P1" runat="server">
            <label for="<%=ddlNevigation.ClientID %>">
                ...
                <asp:DropDownList ID="ddlNevigation" AutoPostBack="true" runat="server" OnSelectedIndexChanged="ddlNevigation_SelectedIndexChanged">
                </asp:DropDownList>
            </label>
        </p>
        <p id="P3" runat="server" visible="false">
        ...
        <br />
        <br />
        <asp:GridView ID="grdProfilePdf" runat="server" AutoGenerateColumns="False" DataKeyNames="Temp_Profile_Id"
            Width="100%">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Designation" SortExpression="Designation" HeaderStyle-CssClass="Text-Center">
                    <ItemTemplate>
        ...
        <asp:GridView ID="grdCMSMenu" runat="server" AutoGenerateColumns="False" DataKeyNames="Temp_Profile_Id"
            ...
            <Columns>
                ...
                <asp:TemplateField ItemStyle-CssClass="Text-Center" HeaderStyle-CssClass="Text-Center">
                    ...
                    <ItemTemplate>
                        <a href="ProfileAdd.aspx?TempProfile_Id=<%#DataBinder.Eval(Container.DataItem,"Temp_Profile_Id")%>&ModuleID=<%#DataBinder.Eval(Container.DataItem,"Module_Id")%>&statusID=<%#DataBinder.Eval(Container.DataItem,"Status_Id")%>&LangID=<%#DataBinder.Eval(Container.DataItem,"Lang_Id")%>&NavigationId=<%#DataBinder.Eval(Container.DataItem,"Nevigation_Id")%>&DepId=<%#ddlDepartment.SelectedValue %>">
                            <asp:Image ID="imgedit" runat="server" ImageUrl="../images/edit.gif" ToolTip="Edit" />
                        </a>
                        <asp:Image ID="emgnotedit" runat="server" ToolTip="pending" Height="15" Width="15" />
                ...
                <asp:TemplateField ItemStyle-CssClass="Text-Center" HeaderStyle-CssClass="Text-Center">
                    <ItemTemplate>
                        <asp:ImageButton ID="imgDelete" runat="server" border="0" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "Temp_Profile_Id") %>'
                ...
                <asp:TemplateField Visible="false" ItemStyle-CssClass="Text-Center" HeaderStyle-CssClass="Text-Center">
                    ...
                    <ItemTemplate>
                        <asp:ImageButton ID="BtnRestore" ImageUrl="~/Auth/AdminPanel/images/restoreIconLarge.jpg"
                            runat="server" Height="15px" Width="15px" CommandName="Restore" CommandArgument='<%# Eval("Temp_Profile_Id") %>'
                            Text="Restore" ToolTip="Restore" OnClientClick="return confirm('Are You sure want to Restore?');" />
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField ItemStyle-CssClass="Text-Center" HeaderStyle-CssClass="Text-Center">
                    <HeaderTemplate>
                    ...
                    <ItemTemplate>
                        <asp:ImageButton ID="btnAudit" ImageUrl="~/Auth/AdminPanel/images/Audit.png" runat="server"
                            Height="15px" Width="15px" CommandName="Audit" CommandArgument='<%# Eval("Temp_Profile_Id") %>'
