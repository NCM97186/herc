        ...
        <div id="tab1" class="tab-content default-tab" style="display: block;">
            <div class="table">
                ...
                <p>
                    ...
                    <asp:TextBox ID="TxtUsername" runat="server" CssClass="text-input medium-input" 
                ...
                <p>
                    ...
                    <asp:TextBox ID="txtName" runat="server" CssClass="text-input small-input" 
                        Enabled="false" MaxLength="30" ReadOnly="True"></asp:TextBox>
