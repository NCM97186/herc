            ...
            <asp:GridView ID="grdAppeal" runat="server" AutoGenerateColumns="false" DataKeyNames="TmpID"
                ...
                <Columns>
                    ...
                    <asp:TemplateField ItemStyle-CssClass="Text-Center" HeaderStyle-CssClass="Text-Center">
                        ...
                        <ItemTemplate>
                            <a href="AddEditAppealAward.aspx?appeal_Id=<%#DataBinder.Eval(Container.DataItem,"Appeal_Id")%> &ModuleID=4&ID=<%#DataBinder.Eval(Container.DataItem,"ID")%>&TID=<%#DataBinder.Eval(Container.DataItem,"tmpid")%>&Status=<%#ddlStatus.SelectedValue %>">
