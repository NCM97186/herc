<%@ Page Language="C#" MasterPageFile="~/Auth/AdminPanel/AdminMasterPage.master"
    AutoEventWireup="true" CodeFile="RTI_SAA_Edit.aspx.cs" Inherits="Auth_AdminPanel_RTI_RTI_SAA_Edit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:Panel ID="pnlRTIAdd" runat="server">
        ...
        <p>
            ...
            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txtSAA"
        ...
        <p>
            ...
            <asp:RegularExpressionValidator ID="regReferenceNoEdit" runat="server" ControlToValidate="txtSAppletAuthority"
                ErrorMessage="Reference number must be between 1 to 200 characters and only numbers are applicable."
                ValidationExpression="^[\s\S]{1,200}$" ValidationGroup="Add" Display="Dynamic">
            </asp:RegularExpressionValidator>
            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Please enter valid name. No special characters are allowed except (space,'-_.:;#()/&)"
        ...
        <p>
            ...
            <asp:RegularExpressionValidator Display="Dynamic" ControlToValidate="txtApplicantAdd"
                ID="regApplicantAddLength" ValidationExpression="^[\s\S]{5,2000}$" runat="server"
        ...
        <p>
            <label for="<%= ddlRTISAAStatus_Edit.ClientID %>">
                RTI SAA Status <span class="redtext">* </span>:
                <asp:DropDownList ID="ddlRTISAAStatus_Edit" runat="server" Enabled="false">
                </asp:DropDownList>
                <asp:RequiredFieldValidator ID="rfv_Status_Edit" runat="server" ControlToValidate="ddlRTISAAStatus_Edit"
                    InitialValue="0" Display="Dynamic" ErrorMessage="Please select rti saa status."
                    ValidationGroup="Update" EnableClientScript="false" ForeColor="">
                </asp:RequiredFieldValidator>
        ...
        <p>
            <asp:Button ID="btnUpdateRtiSaa" runat="server" CssClass="button" Text="Update" ValidationGroup="Add"
                OnClick="btnUpdateRtiSaa_Click" />
            <asp:Button ID="btnReset" runat="server" Text="Reset" CausesValidation="False" CssClass="button"
                OnClick="btnReset_Click" Style="height: 26px" />
