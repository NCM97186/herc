<%@ Page Language="C#" MasterPageFile="~/Auth/AdminPanel/AdminMasterPage.master"
    AutoEventWireup="true" CodeFile="DisplayRTIFAA.aspx.cs" Inherits="Auth_AdminPanel_RTI_DisplayRTIFAA" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        window.onload = function () {
            ...
            TotalChkBx = parseInt('<%= this.grdRTIFAA.Rows.Count %>');
            //Get total no. of checked CheckBoxes in side the GridView.
            Counter = 0;
        }
        function HeaderClick(CheckBox) {
            //Get target base & child control.
            var TargetBaseControl = document.getElementById('<%= this.grdRTIFAA.ClientID %>');
    ...
    <asp:Panel ID="pnlGrid" runat="server">
        ...
        <br />
        <p>
            <asp:GridView ID="grdRTIFAAPdf" runat="server" Visible="false" AutoGenerateColumns="false"
                Width="100%" OnRowDataBound="grdRTIFAAPdf_RowDataBound">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Ref No (HERC/RTI)" SortExpression="Ref_No" ItemStyle-CssClass="Text-Center"
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lnk_Reference_Number" runat="server" Text='<%#Eval("Ref_No")%>' CommandName="View"
                                CommandArgument='<%# DataBinder.Eval(Container.DataItem, "Temp_RTI_FAA_Id") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="FAA Ref No (HERC/FAA)" SortExpression="FAA" ItemStyle-CssClass="Text-Center"
                        HeaderStyle-CssClass="Text-Center">
                        <ItemTemplate>
                            <asp:Label ID="lblFAAReference" runat="server" Text='<%#Eval("FAA") %>'></asp:Label>
                            <asp:HiddenField ID="hydYear" runat="server" Value='<%#Eval("Year") %>'></asp:HiddenField>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Applicant Phone Number" HeaderStyle-CssClass="Text-Center">
                        <ItemTemplate>
                            <asp:Label ID="lblApplicantMobNumber" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Applicant_Phone_No") %>'>
                            </asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Status" SortExpression="RTI_Status" HeaderStyle-CssClass="Text-Center">
                        <ItemTemplate>
                            ...
                            <%-- <asp:HiddenField ID="status" runat="server" Value='<%#Eval("RTI_FAA_Status_Id") %>' />
            ...
            <asp:GridView ID="grdRTIFAA" runat="server" AutoGenerateColumns="false" DataKeyNames="Temp_RTI_FAA_Id"
                OnRowCommand="grdRTIFAA_RowCommand" OnRowCreated="grdRTIFAA_RowCreated" OnRowDataBound="grdRTIFAA_RowDataBound"
                CssClass="mGrid" OnRowDeleting="grdRTIFAA_RowDeleting" AllowPaging="True" PageSize="10"
                OnPageIndexChanging="grdRTIFAA_PageIndexChanging" AllowSorting="true" OnSorting="grdRTIFAA_Sorting">
                <Columns>
                    ...
                    <asp:TemplateField Visible="false">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lblRTIFAA_ID" runat="server" Text='<%#Eval("Temp_RTI_FAA_Id")%>'>
                            </asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Ref No (HERC/RTI)" SortExpression="Ref_No" ItemStyle-CssClass="Text-Center"
                    ...
                    <asp:TemplateField ItemStyle-CssClass="Text-Center">
                        ...
                        <ItemTemplate>
                            <asp:LinkButton ID="lnkChangeStatus" runat="server" Text='Change Status' CommandName="ChangeStatus"
                                CommandArgument='<%# DataBinder.Eval(Container.DataItem, "Temp_RTI_FAA_Id")%>'></asp:LinkButton>
                    ...
                    <asp:TemplateField ItemStyle-CssClass="Text-Center" HeaderStyle-CssClass="Text-Center">
                        ...
                        <ItemTemplate>
                            <asp:LinkButton ID="lnkAppeal" Visible="false" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Appeal")%>'
                                CommandName="Appeal" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "Temp_RTI_FAA_Id")+ ";" +DataBinder.Eval(Container.DataItem, "Ref_No")+ ";" +DataBinder.Eval(Container.DataItem, "Deptt_Id")%>'></asp:LinkButton>
                    ...
                    <asp:TemplateField ItemStyle-CssClass="Text-Center" HeaderStyle-CssClass="Text-Center">
                        ...
                        <ItemTemplate>
                            <a href="RTI_FAA_Edit.aspx?rti_faa_Id=<%#DataBinder.Eval(Container.DataItem,"Temp_RTI_FAA_Id")%> &ModuleID= <%=Convert.ToInt16( Module_ID_Enum.Project_Module_ID.RTI) %>&LangID=<%#DataBinder.Eval(Container.DataItem,"Lang_Id")%>&DepttID=<%#DataBinder.Eval(Container.DataItem,"Deptt_Id")%>&Status=<%#ddlStatus.SelectedValue %>">
                    ...
                    <asp:TemplateField ItemStyle-CssClass="Text-Center" HeaderStyle-CssClass="Text-Center">
                        <ItemTemplate>
                            <asp:ImageButton ID="BtnDelete" ImageUrl="~/Auth/AdminPanel/images/cross.png" runat="server"
                                CommandName="delete" CommandArgument='<%# Eval("Temp_RTI_FAA_Id")+ ";" + Eval("Status_id")%>'
                    ...
                    <asp:TemplateField Visible="false" ItemStyle-CssClass="Text-Center" HeaderStyle-CssClass="Text-Center">
                        ...
                        <ItemTemplate>
                            <asp:ImageButton ID="BtnRestore" ImageUrl="~/Auth/AdminPanel/images/restoreIconLarge.jpg"
                                runat="server" Height="15px" Width="15px" CommandName="Restore" CommandArgument='<%# Eval("Temp_RTI_FAA_Id") %>'
                    ...
                    <asp:TemplateField ItemStyle-CssClass="Text-Center" HeaderStyle-CssClass="Text-Center">
                        ...
                        <ItemTemplate>
                            <asp:ImageButton ID="btnAudit" ImageUrl="~/Auth/AdminPanel/images/Audit.png" runat="server"
                                Height="15px" Width="15px" CommandName="Audit" CommandArgument='<%# Eval("Temp_RTI_FAA_Id") %>'
            ...
            <ContentTemplate>
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td valign="top">
                            <asp:Label ID="lblRefNoFAA" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td valign="top">
                    ...
                    <tr id="trAuthority" runat="server" visible="false">
                        ...
                        <td valign="top">
                            ...
                            <asp:RegularExpressionValidator Display="Dynamic" ControlToValidate="txtOther" ID="regOtherAuthority"
