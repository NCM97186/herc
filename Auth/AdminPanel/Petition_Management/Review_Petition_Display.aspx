            ...
            <asp:GridView ID="grdReview" runat="server" AutoGenerateColumns="false" DataKeyNames="Temp_RP_Id"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Date" SortExpression="ReviewpetitionDateSort" ItemStyle-CssClass="Text-Center"
                        HeaderStyle-CssClass="Text-Center">
                        <ItemTemplate>
                        <asp:Label ID="lblddt" runat="server" Text='<%#Eval("Reviewpetition_Date")%>'>
                            </asp:Label>
                    ...
                    <asp:TemplateField ItemStyle-CssClass="Text-Center" HeaderStyle-CssClass="Text-Center">
                        ...
                        <ItemTemplate>
                            <a href="PetitionReview_Insert_Update.aspx?rp_id=<%#DataBinder.Eval(Container.DataItem,"Temp_RP_Id")%> &ModuleID= <%=Convert.ToInt16( Module_ID_Enum.Project_Module_ID.Petition) %>&LangID=<%#DataBinder.Eval(Container.DataItem,"Lang_Id")%>&Status=<%#ddlStatus.SelectedValue %>">
