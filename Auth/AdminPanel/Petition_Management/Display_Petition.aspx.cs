...
public partial class Auth_AdminPanel_Petition_Management_Display_Petition :CrsfBase //System.Web.UI.Page
{
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        if (p_Var.Result > 0)
        {
            ...
            obj_audit.Title = Convert.ToString(Session["ProNumber"]);// "Petition";
...
GridViewRow row1 = (GridViewRow)(((Control)e.CommandSource).NamingContainer);
                    ...
                    if (p_Var.Result > 0)
                    {
                        ...
                        obj_audit.Title = lblProNumber.Text;// "Petition";
                        obj_auditDl.InsertModuleAuditTrailDetails(obj_audit);
    ...
    protected void grdPetition_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        else
        {
            ...
            if (p_Var.Result > 0)
            {
                ...
                obj_audit.IpAddress = miscellBL.IpAddress();
                obj_audit.status = ddlStatus.SelectedItem.ToString();
                Label lblpronumber = grdPetition.Rows[e.RowIndex].Cells[8].FindControl("lblProNumber") as Label;
                obj_audit.Title = lblpronumber.Text;// "Petition";
                obj_auditDl.InsertModuleAuditTrailDetails(obj_audit);
