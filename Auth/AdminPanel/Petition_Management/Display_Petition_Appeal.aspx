<%@ Page Language="C#" MasterPageFile="~/Auth/AdminPanel/AdminMasterPage.master"
    AutoEventWireup="true" CodeFile="Display_Petition_Appeal.aspx.cs" Inherits="Auth_AdminPanel_Petition_Management_Display_Petition_Appeal" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel ID="pnlGrid" runat="server">
        <p style="float: right">
            ...
            <asp:Button ID="btnReview" runat="server" CssClass="button" Text="Review Petition"
                OnClick="btnReview_View_Click" ToolTip="View Review Petition" />
        </p>
        ...
        <br />
        <p>
            <asp:GridView ID="grdPetitionAppealPdf" runat="server" Visible="false" AutoGenerateColumns="false"
                OnRowDataBound="grdPetitionAppealPdf_RowDataBound" DataKeyNames="Temp_PA_Id">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Appeal No(HERC Reference No)" ItemStyle-CssClass="Text-Center"
                        HeaderStyle-CssClass="Text-Center">
                        <ItemTemplate>
                            <asp:Label ID="lblPro" runat="server" Text='<%#Eval("Appeal_No")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Petition Appeal Date" ItemStyle-CssClass="Text-Center"
                        HeaderStyle-CssClass="Text-Center">
                        <ItemTemplate>
                            <%# DataBinder.Eval(Container.DataItem, "AppealDate")%>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Petitioner Name" ItemStyle-CssClass="Text-Center"
                        HeaderStyle-CssClass="Text-Center">
                        <ItemTemplate>
                            <asp:Label ID="lblPetitionerName" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "Applicant_Name")%>'>
                            </asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Petitioner Address" ItemStyle-CssClass="Text-Center"
                        HeaderStyle-CssClass="Text-Center">
                        <ItemTemplate>
                            <asp:Label ID="lblPetitionerAddress" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "Petitioner_Address")%>'>
                            </asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Respondent Name" ItemStyle-CssClass="Text-Center"
                        HeaderStyle-CssClass="Text-Center">
                        <ItemTemplate>
                            <asp:Label ID="lblRespondentName" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "Respondent")%>'>
                            </asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Respondent Address" ItemStyle-CssClass="Text-Center"
                        HeaderStyle-CssClass="Text-Center">
                        <ItemTemplate>
                            <asp:Label ID="lblRespondentAddress" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "Respondent_Address")%>'>
                            </asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Petition Appeal File" HeaderStyle-CssClass="Text-Center">
                        <ItemTemplate>
                            <asp:Literal ID="ltrlConnectedFile1" runat="server"></asp:Literal>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Order Date against which Appeal is filed" SortExpression="OrderDateSort"
                        ItemStyle-CssClass="Text-Center" HeaderStyle-CssClass="Text-Center">
                        <ItemTemplate>
                            <%# DataBinder.Eval(Container.DataItem, "OrderDate")%>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Status" SortExpression="PA_Status" HeaderStyle-CssClass="Text-Center">
                        <ItemTemplate>
                            <%# DataBinder.Eval(Container.DataItem, "PA_Status")%>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Judgement Link" SortExpression="Judgement_Link" HeaderStyle-CssClass="Text-Center">
                        <ItemTemplate>
                            <asp:Label ID="lblJudgementLink" runat="server" Text='<%#Eval("Judgement_Link")%>'>
                            </asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
            ...
            <asp:GridView ID="grdAppeal" runat="server" AutoGenerateColumns="false" DataKeyNames="Temp_PA_Id"
                ...
                <Columns>
                    ...
                    <asp:TemplateField Visible="false">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lblPA_ID" runat="server" Text='<%#Eval("Temp_PA_Id")%>'>
                            </asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Appeal No" SortExpression="Appeal_No" ItemStyle-CssClass="Text-Center"
                        HeaderStyle-CssClass="Text-Center">
                        <ItemTemplate>
                            <asp:Label ID="lblProNumber" runat="server" Text='<%#Eval("Appeal_No")%>'></asp:Label>
                            <%--   <asp:LinkButton ID="lnk_Appeal_Number" runat="server" Text='<%#Eval("Appeal_No")%>'
                            CommandName="View" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "Temp_PA_Id") %>'></asp:LinkButton>
                        <%# DataBinder.Eval(Container.DataItem, "Appeal_No")%>--%>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Order Date against which Appeal is filed" SortExpression="OrderDateSort"
                        ItemStyle-CssClass="Text-Center" HeaderStyle-CssClass="Text-Center">
                    ...
                    <asp:TemplateField ItemStyle-CssClass="Text-Center" HeaderStyle-CssClass="Text-Center">
                        ...
                        <ItemTemplate>
                            <a href="Petition_Appeal_Insert_Update.aspx?pa_id=<%#DataBinder.Eval(Container.DataItem,"Temp_PA_Id")%> &ModuleID= <%=Convert.ToInt16( Module_ID_Enum.Project_Module_ID.Petition) %>&LangID=<%#DataBinder.Eval(Container.DataItem,"Lang_Id")%>&Status=<%#ddlStatus.SelectedValue %>">
                    ...
                    <asp:TemplateField ItemStyle-CssClass="Text-Center" HeaderStyle-CssClass="Text-Center">
                        <ItemTemplate>
                            <asp:ImageButton ID="BtnDelete" ImageUrl="~/Auth/AdminPanel/images/cross.png" runat="server"
                                CommandName="Delete" CommandArgument='<%# Eval("Temp_PA_Id") +" ; "+  Eval("Status_id") %>'
                    ...
                    <asp:TemplateField Visible="false" ItemStyle-CssClass="Text-Center" HeaderStyle-CssClass="Text-Center">
                        ...
                        <ItemTemplate>
                            <asp:ImageButton ID="BtnRestore" ImageUrl="~/Auth/AdminPanel/images/restoreIconLarge.jpg"
                                runat="server" Height="15px" Width="15px" CommandName="Restore" CommandArgument='<%# Eval("Temp_PA_Id") %>'
                    ...
                    <asp:TemplateField ItemStyle-CssClass="Text-Center" HeaderStyle-CssClass="Text-Center">
                        ...
                        <ItemTemplate>
                            <asp:LinkButton ID="lnkChangeStatus" runat="server" Text='Change Status' CommandName="ChangeStatus"
                                CommandArgument='<%# DataBinder.Eval(Container.DataItem, "Temp_PA_Id")%>'></asp:LinkButton>
                    ...
                    <asp:TemplateField ItemStyle-CssClass="Text-Center" HeaderStyle-CssClass="Text-Center">
                        ...
                        <ItemTemplate>
                         <asp:ImageButton ID="btnAudit" ImageUrl="~/Auth/AdminPanel/images/Audit.png"
                                runat="server" Height="15px" Width="15px" CommandName="Audit" CommandArgument='<%# Eval("Temp_PA_Id") %>'
            ...
            <p>
                ...
                &nbsp;<asp:Button ID="btnDisApprove" runat="server" Text="Disapprove" CssClass="button"
                    ...
                    Style="height: 26px" ToolTip="Click To Disapprove" />
            </p>
    </asp:Panel>
