<%@ Page Language="C#" MasterPageFile="~/Auth/AdminPanel/AdminMasterPage.master"
    AutoEventWireup="true" CodeFile="PublicNoticeAdd_Edit.aspx.cs" Inherits="Auth_AdminPanel_PublicNotice_PublicNoticeAdd_Edit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        function CustomValidator_funcation(source, arguments) {
            var txtEmails1 = document.getElementById("TextBox1");

            var Filter = /^\w+@[a-zA-Z_]+?\.[a-zA-Z]{2,3}$/;



            if (Filter.test(txtEmails1.value))
    ...
    <%--  <p>
        <asp:LinkButton ID="lnkMultipleUpload" runat="server" Text="Upload Multiple File"
            OnClick="lnkMultipleUpload_Click">
        </asp:LinkButton>
    </p>--%>
    <p>
        <label for="<%= lnkConnectedPetition.ClientID %>" style="color: Red">
            Do you want to connect petition/Review Petition with this public notice? :
        ...
        <input id="Button1" onclick="AddFileUpload()" style="height: 27px; width: 74px;"
            ...
            <!--Validation for small description on date 28-10-2013 for security-->
             <asp:RegularExpressionValidator ID="RegularExpressionValidator26" runat="server"
                    ControlToValidate="txtURL" Display="Dynamic" ErrorMessage="Please enter valid url"
    ...
    <p>
        ...
        <asp:Button ID="BtnUpdate" runat="server" CssClass="button" Text="Update" ValidationGroup="Add"
            OnClick="BtnUpdate_Click" ToolTip="Click To Udate" />
