<%@ Page Language="C#" MasterPageFile="~/Auth/AdminPanel/AdminMasterPage.master"
    AutoEventWireup="true" CodeFile="AddAwards.aspx.cs" Inherits="Auth_AdminPanel_AwardsPronounced_AddAwards" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel ID="pnlRTIAdd" runat="server">
        ...
        <p id="pAward" runat="server" visible="false">
            ...
            <asp:RegularExpressionValidator ID="regtxtAward" runat="server" ErrorMessage="Please enter valid title. No special characters are allowed except (space,'-_.:;#()/&)"
        ...
        <p>
            ...
            <!--Validation for small description on date 28-10-2013 for security-->
            <asp:RegularExpressionValidator ID="regAwardSubject" runat="server" ErrorMessage="Please enter valid subject. No special characters are allowed except (space,'-_.:;#()/&)"
        ...
        <p>
            <div id="FileUploadContainer">
                ...
                <!--Validation for small description on date 28-10-2013 for security-->
                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="Please enter valid file description. No special characters are allowed except (space,'-_.:;#()/&)"
        ...
        <p>
            ...
            <asp:RegularExpressionValidator Display="Dynamic" ControlToValidate="txtMetaDescription"
                ...
                ValidationGroup="Add" ErrorMessage="Minimum 3 and maximum 2000 characters required."></asp:RegularExpressionValidator>
            <asp:RequiredFieldValidator ID="regMetadesc" runat="server" ControlToValidate="txtMetaDescription"
