            ...
            <asp:GridView ID="GvAdd_Details" runat="server" DataKeyNames="Temp_Link_Id" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField ItemStyle-CssClass="Text-Center" HeaderStyle-CssClass="Text-Center">
                        ...
                        <ItemTemplate>
                            <a href="Add_Modules.aspx?Temp_Link_Id=<%#DataBinder.Eval(Container.DataItem,"Temp_Link_Id")%>&ModuleID=<%#DataBinder.Eval(Container.DataItem,"Module_Id")%>&LangID=<%#DataBinder.Eval(Container.DataItem,"Lang_Id")%>&amb=<%#DataBinder.Eval(Container.DataItem,"RegulationNoAmbendment") %>">
