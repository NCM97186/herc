<%@ Page Language="C#" MasterPageFile="~/Auth/AdminPanel/AdminMasterPage.master"
    AutoEventWireup="true" CodeFile="DisplayAwards.aspx.cs" Inherits="Auth_AdminPanel_AwardsPronounced_DisplayAwards" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel ID="pnlGrid" runat="server">
        <p style="float: right">
            ...
            <asp:Button ID="btnAddAward" runat="server" CssClass="button" Text="New Award" OnClick="btnAddAward_Click"
                ToolTip="Add New Award" />
        </p>
        ...
        <br />
        <p>
            <asp:GridView ID="grdAwardPdf" runat="server" AutoGenerateColumns="false" DataKeyNames="Temp_RA_Id"
                Width="100%" Visible="false" OnRowDataBound="grdAwardPdf_RowDataBound">
                <Columns>
                    ...
                    <asp:BoundField DataFormatString="{0:dd-MMM-yyyy}" SortExpression="AwardDate" HeaderText="Date"
                        HeaderStyle-CssClass="Text-Center" DataField="AwardDate" />
                    <asp:TemplateField HeaderText="Year" ItemStyle-CssClass="Text-Center" HeaderStyle-CssClass="Text-Center">
                        <ItemTemplate>
                            <%# DataBinder.Eval(Container.DataItem, "PlaceholderFive")%>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Subject(s)" HeaderStyle-CssClass="Text-Center">
                        <ItemTemplate>
                            <asp:Label ID="lblSubject" runat="server" Text='<%#Eval("PlaceholderTwo") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Remarks" HeaderStyle-CssClass="Text-Center">
                        <ItemTemplate>
                            <asp:Label ID="lblRemarks" runat="server" Text='<%#Eval("PlaceHolderFour") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
            ...
            <asp:GridView ID="grdOrders" runat="server" AutoGenerateColumns="false" DataKeyNames="Temp_RA_Id"
                ...
                OnPageIndexChanging="grdOrders_PageIndexChanging" AllowSorting="true" OnSorting="grdOrders_Sorting">
                <Columns>
                    ...
                    <asp:TemplateField Visible="false">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lblReviewAppealID" runat="server" Text='<%#Eval("Temp_RA_Id")%>'>
                            </asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Appeal No." SortExpression="appealno" HeaderStyle-CssClass="Text-Center">
                        <ItemTemplate>
                            <asp:Label ID="lblAppealNumber" runat="server" Text='<%#Eval("Appeal_Number")%>'></asp:Label>
                            <asp:HiddenField ID="Hydold" runat="server" Value='<%#Eval("Appeal_ID") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataFormatString="{0:dd-MMM-yyyy}" SortExpression="AwardDate" HeaderText="Date"
                        HeaderStyle-CssClass="Text-Center" DataField="AwardDate" />
                    <asp:TemplateField HeaderText="Year" SortExpression="PlaceholderFive" Visible="false"
                        ItemStyle-CssClass="Text-Center" HeaderStyle-CssClass="Text-Center">
                        <ItemTemplate>
                            <%# DataBinder.Eval(Container.DataItem, "PlaceholderFive")%>
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Appellant(s)" SortExpression="Applicant_Name" HeaderStyle-CssClass="Text-Center">
                        <ItemTemplate>
                            <%# Server.HtmlDecode( Miscelleneous_DL.FixCharacters(DataBinder.Eval(Container.DataItem, "Applicant_Name"), 100))%>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Respondent(s)" SortExpression="Respondent_Name" HeaderStyle-CssClass="Text-Center">
                        <ItemTemplate>
                            <%# Server.HtmlDecode(Miscelleneous_DL.FixCharacters(DataBinder.Eval(Container.DataItem, "Respondent_Name"), 100))%>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Subject(s)" SortExpression="PlaceholderTwo" HeaderStyle-CssClass="Text-Center">
                        <ItemTemplate>
                            <%# Server.HtmlDecode(Miscelleneous_DL.FixCharacters(DataBinder.Eval(Container.DataItem, "PlaceholderTwo"), 100))%>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField ItemStyle-CssClass="Text-Center" HeaderStyle-CssClass="Text-Center">
                        ...
                        <ItemTemplate>
                            <a href="EditAwards.aspx?AwardID=<%#DataBinder.Eval(Container.DataItem,"Temp_RA_Id")%> &ModuleID= <%=Convert.ToInt16( Module_ID_Enum.Project_Module_ID.AwardPronounced) %>&LangID=<%#DataBinder.Eval(Container.DataItem,"Lang_Id")%>&AppealID=<%#DataBinder.Eval(Container.DataItem,"Appeal_ID")%>">
                    ...
                    <asp:TemplateField ItemStyle-CssClass="Text-Center" HeaderStyle-CssClass="Text-Center">
                        <ItemTemplate>
                            ...
                            <asp:ImageButton ID="BtnDelete" ImageUrl="~/Auth/AdminPanel/images/cross.png" runat="server"
                                CommandName="delete" CommandArgument='<%# Eval("Temp_RA_Id")%>' Text="Delete"
                                ToolTip="Delete" /><%--OnClientClick="return confirm('Are You sure want to delete this order?');"--%>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField Visible="false" ItemStyle-CssClass="Text-Center" HeaderStyle-CssClass="Text-Center">
                        ...
                        <ItemTemplate>
                            <asp:ImageButton ID="BtnRestore" ImageUrl="~/Auth/AdminPanel/images/restoreIconLarge.jpg"
                                runat="server" Height="15px" Width="15px" CommandName="Restore" CommandArgument='<%# Eval("Temp_RA_Id") %>'
                    ...
                    <asp:TemplateField ItemStyle-CssClass="Text-Center" HeaderStyle-CssClass="Text-Center">
                        ...
                        <ItemTemplate>
                            <asp:ImageButton ID="btnAudit" ImageUrl="~/Auth/AdminPanel/images/Audit.png" runat="server"
                                Height="15px" Width="15px" CommandName="Audit" CommandArgument='<%# Eval("Temp_RA_Id") %>'
