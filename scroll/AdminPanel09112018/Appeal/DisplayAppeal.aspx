            ...
            <asp:GridView ID="grdAppeal" runat="server" AutoGenerateColumns="false" DataKeyNames="Temp_Appeal_Id"
                ...
                <Columns>
                    ...
                    <asp:TemplateField ItemStyle-CssClass="Text-Center" HeaderStyle-CssClass="Text-Center">
                        ...
                        <ItemTemplate>
                            <a href="Appeal_Edit.aspx?appeal_Id=<%#DataBinder.Eval(Container.DataItem,"Temp_Appeal_Id")%> &ModuleID= <%=Convert.ToInt16( Module_ID_Enum.Project_Module_ID.Appeal) %>&LangID=<%#DataBinder.Eval(Container.DataItem,"Lang_Id")%>">
