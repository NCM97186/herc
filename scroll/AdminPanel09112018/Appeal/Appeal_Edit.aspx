<%@ Page Language="C#" MasterPageFile="~/Auth/AdminPanel/AdminMasterPage.master"
    AutoEventWireup="true" CodeFile="Appeal_Edit.aspx.cs" Inherits="Auth_AdminPanel_Appeal_Appeal_Edit" %>
      ...
      Display="Dynamic" ErrorMessage="Start Date Must Be Greater Than OR Equal To Current Date..!"  ValidationGroup="Add" ></asp:CustomValidator>--%>
        ...
        <p>
            ...
            <asp:RegularExpressionValidator Display="Dynamic" ControlToValidate="txtApplicantAdd"
                ID="regApplicantadd" ValidationExpression="^[\s\S]{3,2000}$" runat="server" ValidationGroup="Add"
                ErrorMessage="Minimum 3 and maximum 2000 characters required.">
            </asp:RegularExpressionValidator>
        ...
        <p>
            ...
            <br />
            <em><span style="font-size: 8pt; font-weight: bold; color: #459300; font-family: Verdana">
                Tip:-Enter Phone No. with STD code (without ‘0’) and enter multiple phone numbers
                separated with semicolon(;).</span></em>
        </p>
        <p>
        ...
        <p>
            ...
            <asp:RegularExpressionValidator Display="Dynamic" ControlToValidate="txtRespondentName"
                ID="regResponName" ValidationExpression="^[\s\S]{3,2000}$" runat="server" ValidationGroup="Add"
                ErrorMessage="Minimum 3 and maximum 2000 characters required.">
            </asp:RegularExpressionValidator>
        ...
        <p>
            ...
            <asp:RegularExpressionValidator Display="Dynamic" ControlToValidate="txtRespondentAddress"
                ID="regResponAddress" ValidationExpression="^[\s\S]{3,2000}$" runat="server"
                ValidationGroup="Add" ErrorMessage="Minimum 3 and maximum 2000 characters required.">
            </asp:RegularExpressionValidator>
            <asp:RegularExpressionValidator ID="regRepondentAddress" runat="server" ErrorMessage="Please enter valid address. No special characters are allowed except (space,'-_.:;#()/&)"
        ...
        <p>
            ...
            <asp:RegularExpressionValidator ID="regRespondentMobileNo" runat="server" ErrorMessage="Please enter valid Mobile number."
                ControlToValidate="txtRespondentMobileNo" Display="Dynamic" ValidationExpression="^[1-9][0-9]{9,10}(([;][1-9][0-9]{9,10})*)?$"
                ValidationGroup="Add" />
            <br />
            <em><span style="font-size: 8pt; font-weight: bold; color: #459300; font-family: Verdana">
                Tip:-Don’t start with ‘0’ (zero). You may enter multiple mobile numbers separated
        ...
        <p>
            ...
            <asp:RegularExpressionValidator ID="regRespondentFaxNo" runat="server" ErrorMessage="Please enter valid Fax number."
                ...
                ValidationGroup="Add" />
            <%--            <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender6" runat="server" TargetControlID="txtRespondentFaxNo"
        ...
        <p>
            ...
            <asp:RegularExpressionValidator ID="regAppealSubject" runat="server" ErrorMessage="Please enter valid subject. No special characters are allowed except (space,'-_.:;#()/&)"
            ...
            <asp:RegularExpressionValidator Display="Dynamic" ControlToValidate="txtAppealSubject"
                ID="RegularExpressionValidator1" ValidationExpression="^[\s\S]{3,2000}$" runat="server"
                ValidationGroup="Add" ErrorMessage="Minimum 3 and maximum 2000 characters required.">
            </asp:RegularExpressionValidator>
            <br />
            <em><span style="font-size: 8pt; font-weight: bold; color: #459300; font-family: Verdana">
        ...
        <p>
            <label for="<%= ddlAppealStatus.ClientID %>">
                ...
                <asp:RequiredFieldValidator ID="rfv_Status_Edit" runat="server" ControlToValidate="ddlAppealStatus"
        ...
        <p>
            <asp:Button ID="btnUpdateAppeal" runat="server" CssClass="button" Text="Update" ValidationGroup="Add"
                OnClick="btnUpdateAppeal_Click" />
