<%@ Page Language="C#" MasterPageFile="~/Auth/AdminPanel/AdminMasterPage.master"
    AutoEventWireup="true" CodeFile="Order_Add.aspx.cs" Inherits="Auth_AdminPanel_OrderManagement_Order_Add" %>
    ...
    <asp:Panel ID="pnlRTIAdd" runat="server">
        ...
        <asp:Panel ID="pnlDropdownlist" runat="server">
            <p>
                <label for="<%=ddlConnectionType.ClientID %>">
                    <asp:Label ID="lblPetitionreview" runat="server" Text="Select Petition/Review Petition:"
            ...
            <asp:Panel ID="pnlPetitionSection" runat="server" Visible="false">
                ...
                <p id="pPetitionNumber" runat="server" visible="false">
                    <div style="width: 487px; max-height: 350px; overflow: auto;" id="divConnectAdd1"
                        ...
                        <label for="<%=chklstPetition.ClientID %>">
                            Select Petition/Review Petition <span class="redtext">* </span>:</label>
        ...
        <p id="petitionDetails" runat="server">
            ...
            <p>
                ...
                <%--<cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" runat="server" TargetControlID="txtRespondentMobileNo"
            ...
            <p>
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="Please enter valid Phone number."
                    ...
                    ValidationGroup="Add" />
                <%--<cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender4" runat="server" TargetControlID="txtRespondentPhoneNo"
                ValidChars="0123456789">
            </cc1:FilteredTextBoxExtender>--%>
                <br />
                <em><span style="font-size: 8pt; font-weight: bold; color: #459300; font-family: Verdana">
            ...
            <p>
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ErrorMessage="Please enter valid Fax number."
                    ...
                    ValidationGroup="Add" />
                <%--<cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender5" runat="server" TargetControlID="txtRespondentFaxNo"
                ValidChars="0123456789">
            </cc1:FilteredTextBoxExtender>--%>
                <br />
                <em><span style="font-size: 8pt; font-weight: bold; color: #459300; font-family: Verdana">
        ...
        <p id="pCategory" runat="server" visible="false">
            ...
            <asp:CustomValidator runat="server" ID="cvmodulelist" ForeColor="Red" ClientValidationFunction="ValidateModuleList"
                OnServerValidate="valInquiry_ServerValidation" ErrorMessage="Please select atleast one checkbox"
        ...
        <p id="pEnddate" runat="server" visible="false">
            ...
            3 months from start date--%></span></em></p>
        <p>
            ...
            <asp:RegularExpressionValidator Display="Dynamic" ControlToValidate="txtRemarks"
                ID="RegularExpressionValidator4" ValidationExpression="^[\s\S]{5,2000}$" runat="server"
                ValidationGroup="Add" ErrorMessage="Minimum 5 and maximum 2000 characters required.">
            </asp:RegularExpressionValidator>
            <!--Validation for title on date 28-10-2013-->
        ...
        <p>
            <asp:Button ID="btnAddOrder" runat="server" CssClass="button" Text="Submit" ValidationGroup="Add"
                OnClick="btnAddOrder_Click" CausesValidation="true" ToolTip="Click To Save" />
