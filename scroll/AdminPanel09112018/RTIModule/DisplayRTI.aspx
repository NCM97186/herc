            ...
            <asp:GridView ID="grdRTI" runat="server" AutoGenerateColumns="false" DataKeyNames="Temp_RTI_Id"
                ...
                <Columns>
                    ...
                    <asp:TemplateField ItemStyle-CssClass="Text-Center">
                        ...
                        <ItemTemplate>
                            <a href="RTIEdit.aspx?rti_Id=<%#DataBinder.Eval(Container.DataItem,"Temp_RTI_Id")%> &ModuleID= <%=Convert.ToInt16( Module_ID_Enum.Project_Module_ID.RTI) %>&LangID=<%#DataBinder.Eval(Container.DataItem,"Lang_Id")%>&DepttID=<%#DataBinder.Eval(Container.DataItem,"Deptt_Id")%>">
