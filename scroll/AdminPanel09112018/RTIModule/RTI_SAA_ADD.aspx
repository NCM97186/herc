<%@ Page Language="C#" MasterPageFile="~/Auth/AdminPanel/AdminMasterPage.master"
    AutoEventWireup="true" CodeFile="RTI_SAA_ADD.aspx.cs" Inherits="Auth_AdminPanel_RTI_RTI_SAA_ADD" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:Panel ID="pnlRTIAdd" runat="server">
        ...
        <p>
            <label for="<%=txtSAA.ClientID %>">
                SAA Reference Number (For internal reference only)<span class="redtext">* </span>
                :</label>
            <asp:TextBox ID="txtSAA" CssClass="text-input small-input" runat="server" MaxLength="4"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ValidationGroup="Add" runat="server"
                SetFocusOnError="true" ControlToValidate="txtSAA" ErrorMessage="Please enter SAA Reference Number."
                Display="Dynamic">
            </asp:RequiredFieldValidator>
            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtSAA"
            ...
            <asp:CustomValidator ID="CustomValidator1" runat="server" Display="Dynamic" ErrorMessage="SAA reference number already exist. Please enter another reference number."
                OnServerValidate="cusReferenceNoSAA_ServerValidate" ValidationGroup="Add">
            </asp:CustomValidator>
            <br />
        ...
        <p>
            <label for="<%=txtSAppletAuthority.ClientID %>">
                SIC Reference Number
                <%--<span class="redtext">* </span>--%>:</label>
            <asp:TextBox ID="txtSAppletAuthority" CssClass="text-input small-input" runat="server"
                MaxLength="200"></asp:TextBox>
            <asp:RegularExpressionValidator ID="regReferenceNo" runat="server" ControlToValidate="txtSAppletAuthority"
                ErrorMessage="Reference number must be between 1 to 200 characters are applicable."
                ValidationExpression="^[\s\S]{1,200}$" ValidationGroup="Add" Display="Dynamic">
            </asp:RegularExpressionValidator>
            <asp:CustomValidator ID="cusReferenceNo" runat="server" Display="Dynamic" ErrorMessage="SAA Reference number already exist. Please enter reference number."
                OnServerValidate="cusReferenceNo_ServerValidate" ValidationGroup="Add">
            </asp:CustomValidator>
            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="Please enter valid name. No special characters are allowed except (space,'-_.:;#()/&)"
                ValidationGroup="Add" ControlToValidate="txtSAppletAuthority" SetFocusOnError="true"
                ValidationExpression="([\u0900-\u097F]|[a-z]|[A-Z]|[0-9]|[,'():;/& ]|[#]|[-]|[\r\n]|[_\.])*"
                Display="Dynamic">
            </asp:RegularExpressionValidator>
             <br />
            <em><span style="font-size: 8pt; font-weight: bold; color: #459300; font-family: Verdana">
                Tip:-SIC Reference Number upto 200 characters are allowed.</span></em>
        </p>
        <p>
        ...
        <p>
            ...
            <asp:RegularExpressionValidator ID="regApplicantFaxNo" runat="server" ErrorMessage="Please enter valid Fax number."
                ...
                ValidationGroup="Add" />
            <%-- <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" runat="server" TargetControlID="txtApplicantFaxNo"
                ValidChars="0123456789">
            </cc1:FilteredTextBoxExtender>--%>
            <br />
            <em><span style="font-size: 8pt; font-weight: bold; color: #459300; font-family: Verdana">
                Tip:-Enter Phone No. with STD code (without '0'). You may enter multiple Fax numbers
                separated by semicolon(;).</span></em>
        </p>
        <p>
        ...
        <p>
            ...
            <asp:RegularExpressionValidator Display="Dynamic" ControlToValidate="txtRtiSubject"
                ID="regRtiSubject" ValidationExpression="^[\s\S]{5,2000}$" runat="server" ValidationGroup="Add"
        ...
        <p>
            ...
            <asp:RegularExpressionValidator Display="Dynamic" ControlToValidate="txtremarks"
                ID="regRemarkslength" ValidationExpression="^[\s\S]{5,2000}$" runat="server"
                ValidationGroup="Add" ErrorMessage="Minimum 5 and maximum 2000 characters required.">
            </asp:RegularExpressionValidator>
        ...
        <p>
            <label for="<%= lblRtiStatus.ClientID %>">
                RTI SAA Status <span class="redtext"></span>:
        ...
        <p>
            <asp:Button ID="btnAddRtiSaa" runat="server" CssClass="button" Text="Submit" ValidationGroup="Add"
                OnClick="btnAddRtiSaa_Click" ToolTip="Click To Save" />
