            ...
            <asp:GridView ID="grdPublicNotice" runat="server" AutoGenerateColumns="false" DataKeyNames="PublicNoticeID_tmp"
                ...
                <Columns>
                    ...
                    <asp:TemplateField ItemStyle-CssClass="Text-Center" HeaderStyle-CssClass="Text-Center">
                        ...
                        <ItemTemplate>
                            <a href="PublicNotice_Edit.aspx?publicNoticeID=<%#DataBinder.Eval(Container.DataItem,"PublicNoticeID_tmp")%> &ModuleID= <%=Convert.ToInt16( Module_ID_Enum.Project_Module_ID.Public_Notice) %>&LangID=<%#DataBinder.Eval(Container.DataItem,"Lang_Id")%>">
