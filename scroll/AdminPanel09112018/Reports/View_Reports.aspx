<%@ Page Language="C#" MasterPageFile="~/Auth/AdminPanel/AdminMasterPage.master"
    AutoEventWireup="true" CodeFile="View_Reports.aspx.cs" Inherits="Auth_AdminPanel_Reports_View_Reports" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel ID="pnlGrid" runat="server">
        <p class="buttonAlign">
            ...
            <asp:Button ID="btnAddNewPage" runat="server" CausesValidation="False" Text="Add New Report"
                CssClass="button" OnClick="btnAddNewPage_Click" ToolTip="Add New Report"></asp:Button>
        </p>
        ...
        <p id="pddlStatus" runat="server" visible="false">
            <label for="<%=ddlStatus.ClientID %>">
                Seclect Module Status: <span class="redtext">*
        ...
        <asp:Panel ID="pnlCMSMenu" runat="server">
            <p>
                <asp:GridView ID="grdReportPdf" runat="server" AutoGenerateColumns="False" Width="100%"
                    Visible="false">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Report Heading" SortExpression="Year" HeaderStyle-CssClass="Text-Center">
                            <ItemTemplate>
                ...
                <asp:GridView ID="grdCMSMenu" runat="server" AutoGenerateColumns="False" DataKeyNames="Temp_Link_Id"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Report Heading" SortExpression="Year" HeaderStyle-CssClass="Text-Center">
                            <ItemTemplate>
                                <%--<%# DataBinder.Eval(Container.DataItem, "Year")%>--%>
                                <asp:Label ID="lblReportingHeading" runat="server" Text='<%#Eval("Year") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Created By" SortExpression="InsertedBY" Visible="false">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderStyle-CssClass="Text-Center" ItemStyle-CssClass="Text-Center">
                            ...
                            <ItemTemplate>
                                <a href="AddEdit_Reports.aspx?TempLink_Id=<%#DataBinder.Eval(Container.DataItem,"Temp_Link_Id")%>&ModuleID=<%#DataBinder.Eval(Container.DataItem,"Module_Id")%>&statusID=<%#DataBinder.Eval(Container.DataItem,"Status_Id")%>&LangID=<%#DataBinder.Eval(Container.DataItem,"Lang_Id")%>&Catid=<%#DataBinder.Eval(Container.DataItem,"Cat_Id")%>">
