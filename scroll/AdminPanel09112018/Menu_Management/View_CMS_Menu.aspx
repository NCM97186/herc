<%@ Page Language="C#" MasterPageFile="~/Auth/AdminPanel/AdminMasterPage.master"
    AutoEventWireup="true" CodeFile="View_CMS_Menu.aspx.cs" Inherits="Auth_AdminPanel_Menu_Management_View_CMS_Menu" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel ID="pnlGrid" runat="server">
        <p class="buttonAlign">
            <asp:Button ID="btnAddNewPage" runat="server" CausesValidation="False" Text="Add New Menu"
                CssClass="button" OnClick="btnAddNewPage_Click" ToolTip="Add New Menu"></asp:Button>
        </p>
        ...
        <p>
            <label for="<%=ddlMenuPosition.ClientID %>">
                Position<span class="redtext">* </span>:
        ...
        <p>
		 <label for="<%=lstCMSMenu.ClientID %>">
            Select Main Page Name <span class="redtext">* </span>:
            <asp:ListBox ID="lstCMSMenu" runat="server" CssClass="dropdown" Width="250px" Height="167px"
                AutoPostBack="true" OnSelectedIndexChanged="lstCMSMenu_SelectedIndexChanged">
            </asp:ListBox>
            <asp:RequiredFieldValidator ID="RfvListMenu" ControlToValidate="lstCMSMenu" ValidationGroup="Menu"
                runat="server" ErrorMessage="Please select main Menu" SetFocusOnError="true"></asp:RequiredFieldValidator>
				</label>
        </p>
        <p>
            <label for="<%=ddlStatus.ClientID %>">
                Select Module Status<span class="redtext">*</span>: 
        ...
        <asp:Panel ID="pnlCMSMenu" runat="server">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Menu Name" SortExpression="Name" HeaderStyle-CssClass="Text-Center">
                            <ItemTemplate>
                                ...
                                <asp:Label ID="lblMenuName" runat="server" Text='<%#Eval("Name")%>' Visible="false"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Title" SortExpression="Page_Title" HeaderStyle-CssClass="Text-Center">
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container.DataItem, "Page_Title")%>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Created By" SortExpression="InsertedBY" HeaderStyle-CssClass="Text-Center">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderStyle-CssClass="Text-Center" ItemStyle-CssClass="Text-Center">
                            ...
                            <ItemTemplate>
                                <a href="Add_New_Menu.aspx?TempLink_Id=<%#DataBinder.Eval(Container.DataItem,"Temp_Link_Id")%>&ModuleID=<%#DataBinder.Eval(Container.DataItem,"Module_Id")%>&statusID=<%#DataBinder.Eval(Container.DataItem,"Status_Id")%>&LangID=<%#DataBinder.Eval(Container.DataItem,"Lang_Id")%>&pos=<%#DataBinder.Eval(Container.DataItem,"Position_Id") %>&LinkParentId=<%#DataBinder.Eval(Container.DataItem,"Link_Parent_Id") %>">
                        ...
                        <asp:TemplateField Visible="false" ItemStyle-CssClass="Text-Center" HeaderStyle-CssClass="Text-Center">
                            ...
                            <ItemTemplate>
                                <asp:ImageButton ID="BtnRestore" ImageUrl="~/Auth/AdminPanel/images/restoreIconLarge.jpg"
                                    ...
                                    Text="Restore" ToolTip="Restore" /><%--OnClientClick="return confirm('Are you sure you want to restore this menu ?');"--%>
                            </ItemTemplate>
                        </asp:TemplateField>
            ...
            <asp:Button ID="BtnForReview" runat="server" Text="For review" CssClass="button"
                ...
                ToolTip="Click To Send For Review" Style="height: 26px" />
