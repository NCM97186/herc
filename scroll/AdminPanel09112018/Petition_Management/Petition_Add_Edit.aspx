    ...
    <asp:Panel ID="pnlPetitionAdd" runat="server">
        ...
        <p>
            <label for="<%=txtPetitionPROno.ClientID %>">
                PRO Number <span class="redtext">* </span>:</label>
            ...
            <asp:RequiredFieldValidator ID="rfvPetitionPROno" ValidationGroup="Add" runat="server"
                SetFocusOnError="true" ControlToValidate="txtPetitionPROno" ErrorMessage="Please enter petition PRO number."
                Display="Dynamic"></asp:RequiredFieldValidator>
            <asp:CustomValidator ID="cusPetitionPROno" runat="server" ErrorMessage="PRO number already exist. Please enter another PRO number."
            ...
            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txtPetitionPROno"
                ErrorMessage="PRO number must be between 1 to 9999." ValidationExpression="^[1-9][0-9]{0,3}$"
         ...
         <p>
            ...
            <!--Validation for small description on date 28-10-2013 for security-->
              <asp:RegularExpressionValidator ID="RegtxtAppealLink" runat="server" ControlToValidate="txtURL"
                    Display="Dynamic" ErrorMessage="Please enter valid url" ValidationExpression="^(?:https?:\/\/)?(?:[-a-z0-9]+\\.)+[-a-z0-9]+(?:(?:(?:\/[-=&?.#a-z0-9]+)+)\/?)?$"
    ...
    <asp:Panel ID="pnlEdit" runat="server" Visible="false">
        ...
        <p>
            ...
            <asp:RequiredFieldValidator ID="rfvPetitionPRO_number" ValidationGroup="Update" runat="server"
                SetFocusOnError="true" ControlToValidate="txtPetitionPROno_Edit" ErrorMessage="Please enter petition PRO number."
                Display="Dynamic"></asp:RequiredFieldValidator>
            <asp:CustomValidator ID="cus_PetitionPROno_Edit" runat="server" ErrorMessage="PRO number already exist. Please enter another PRO number."
                OnServerValidate="cus_PetitionPROno_Edit_ServerValidate" ValidationGroup="Update"
                Display="Dynamic">
            </asp:CustomValidator>
            <asp:RegularExpressionValidator ID="regPetitionPRO_Edit" runat="server" ErrorMessage="PRO number must be between 1 to 9999."
