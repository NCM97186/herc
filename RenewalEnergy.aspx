<%@ Page Language="C#" MasterPageFile="~/Usermaster.master" AutoEventWireup="true"
    CodeFile="RenewalEnergy.aspx.cs" Inherits="Renewal_Energy_" %>
        ...
        <div class="working-content-holder">
            <div class="page-had">
                ...
                <div class="page-had-mid-side">
                    <h2>
                        <%=Resources.HercResource.Renewal%></h2>
            ...
            <div class="text-holder">
                ...
                <p id="pyear" runat="server" visible="false">
                    <label for="<%=drpyear.ClientID %>">
                        Select for Renewal Energy:</label>
        ...
        <div class="left-nav-holder">
            ...
            <div class="left-nav-btn">
                <ul>
                    ...
                    <li><a class="current" href="~/RenewalEnergy/532_1_CrosssubsidyandAdditionalSurcharge.aspx" title="Renewal Energy " id="A3"
                        runat="server">
                    ...
                    <li><a class="current" href="~/content/Hindi/RenewalEnergy/807_1_RenewalEnergy.aspx"
                        title="Renewal Energy " id="A10" runat="server">
                        <%=Resources.HercResource.Renewal %>
                    </a></li>
                    <%} %>
                </ul>
