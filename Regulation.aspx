<%@ Page Language="C#" MasterPageFile="~/Usermaster.master" AutoEventWireup="true"
    CodeFile="Regulation.aspx.cs" Inherits="Regulation" %>
        ...
        <div class="left-nav-holder">
            <div class="left-nav-had">
                <div class="left-nav-mid">
                    <h2>
                        <%=Resources.HercResource.Regulations %>
                    </h2>
                </div>
            </div>
            <div class="clear">
            ...
            <div class="left-nav-btn">
                <ul>
                    <% if (Convert.ToInt16(Resources.HercResource.Lang_Id) == Convert.ToInt16(Module_ID_Enum.Language_ID.English))
                       { %>
                    <li><a href="~/Regulation/1.aspx" id="herc" runat="server">
                        <%=Resources.HercResource.herc %></a></li>
                    <li><a href="~/content/192_3_Others.aspx" id="other" runat="server">
                        <%=Resources.HercResource.Others %></a></li>
                    <li><a href="~/Regulation/8.aspx" id="repealed" runat="server">
                        <%=Resources.HercResource.RepealedRegulations %></a></li>
                    <% }

                       else
                       { %>
                    <li><a href="~/content/Hindi/Regulation/1.aspx" id="hercHindi" runat="server">
                        <%=Resources.HercResource.herc %></a></li>
                    <li><a href="~/content/Hindi/203_3_Others.aspx" id="otherHindi" runat="server">
                        <%=Resources.HercResource.Others %></a></li>
                    <li><a href="~/content/Hindi/Regulation/8.aspx" id="repealedHindi" runat="server">
                        <%=Resources.HercResource.RepealedRegulations %></a></li>
                    <%} %>
                </ul>
            </div>
            ...
            <div class="text-holder">
                ...
                <div>
                    <asp:GridView ID="gvRegulations" OnRowDataBound="gvRegulations_RowDataBound" Width="100%"
                        ...
                        UseAccessibleHeader="true" DataKeyNames="Link_Id" ToolTip="Regulations" summary="This table show all Regulations records">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Regulation No." ItemStyle-CssClass="Text-Center">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Description" HeaderStyle-CssClass="Text-Center">
                                <ItemTemplate>
                                    <asp:HyperLink ID="hypFile" runat="server" Text='<%# Server.HtmlDecode((string)Eval("Name"))%>'
                                        NavigateUrl='<%# "~/"+"WriteReadData/Pdf/" + Eval("File_Name") %>' Target="_blank"
                                        ToolTip='<%#Resources.HercResource.ViewDocument %>'></asp:HyperLink>
                            ...
                            <asp:TemplateField HeaderText="Download" ItemStyle-HorizontalAlign="Center" Visible="false">
                                <ItemTemplate>
                                    <asp:LinkButton ID="LinkButton1" CommandName="view" CommandArgument='<%#Eval("File_Name")%>'
                                        runat="server">
                                        <img src='<%=ResolveUrl("~/images/pdf-icon.jpg")%>' title="View Document" width="20"
                                            alt="View Document" height="20" />
                                    </asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
