...
{
    public static Regex forbiddenTags = new Regex("^(script|object|embed|link|style|form|input|iframe|frameset|frame|onabort|onblur|onchange|onclick|ondblclick|onerror|onfocus|onkeydown|onkeypress|onkeyup|onload|onmousedown|onmousemove|onmouseout|onmouseup|onreset|onresize|onselect|onsubmit|onunload|)$");
     ...
     */
    public bool isSanitized(String html)
    {
