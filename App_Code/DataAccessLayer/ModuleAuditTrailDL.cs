...
public class ModuleAuditTrailDL
{
    ...
    public void InsertModuleAuditTrailDetails(ModuleAuditTrail moduleAuditTrail)
    {
        try
        {
            ...
            ncmdbObject.AddParameter("@status", moduleAuditTrail.status);
            ncmdbObject.ExecuteNonQuery("InsertModuleAuditTrailDetails07022019");
    ...
    public DataSet GetModuleAuditTrailDetails(int? ModuleID)
    {
        ...
        return ncmdbObject.ExecuteDataSet("GetModuleAuditTrailDetails07022019");
    }
}