<%@ Page Language="C#" MasterPageFile="~/Usermaster.master" AutoEventWireup="true"
    CodeFile="CurrentAppealPetition.aspx.cs" Inherits="CurrentAppealPetition" Title="" %>
        ...
        <div class="working-content-holder">
            <div class="page-had">
                ...
                <div class="page-had-mid-side">
                    <h2>
                        <%=Resources.HercResource.CurrentYearAppealPetition%></h2>
                    <div class="page-had-right-side">
                        ...
                        <div id="DlastUpdate" runat="server" class="last-updated">
                            <b>
                                <%=Resources.HercResource.LastUpdated %>:</b>
                            <%=lastUpdatedDate %>
                        </div>
                    </div>
                </div>
            ...
            <div class="text-holder">
                ...
                <asp:GridView ID="grdAppeal" runat="server" AutoGenerateColumns="false" OnRowCommand="grdAppeal_RowCommand"
                    OnRowDataBound="grdAppeal_RowDataBound" Width="100%" ToolTip="Current Appeal Petition" summary="This table show all current year petition appeal">
                    <Columns>
                        <asp:TemplateField HeaderText="Petition No" ItemStyle-HorizontalAlign="Center" Visible="false">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkDetails" runat="server" Text='<%#Eval("pronumber") %>' CommandName="View"
                                    CommandArgument='<%# DataBinder.Eval(Container.DataItem, "PA_Id") %>' ToolTip="Click on Petition Number to view Petition details."></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField HeaderText="PRO No" DataField="pronumber" Visible="false" />
                        <asp:BoundField HeaderText="RA No" DataField="RPNO" Visible="false" />
                        <asp:BoundField HeaderText="Year" DataField="Year" Visible="false" />
                      <%--   <asp:BoundField HeaderText="Appeal Number" DataField="appealNo" ItemStyle-HorizontalAlign="Center"
                    ...
                    <asp:BoundField HeaderText="Date" DataField="AppealDate" />
                        ...
                        <asp:TemplateField HeaderText="Where Appealed" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkDetailsWhere" runat="server" Text='<%#Eval("Where_Appealed") %>' CommandName="View"
                                    CommandArgument='<%# DataBinder.Eval(Container.DataItem, "PA_Id") %>' ToolTip="Click on Where Appealed to view details."></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <%-- <asp:BoundField HeaderText="Where Appealed" DataField="Where_Appealed" />--%>
                        ...
                        <asp:TemplateField HeaderText="Download Judgement" ItemStyle-HorizontalAlign="Center"
                            Visible="false">
                            <ItemTemplate>
