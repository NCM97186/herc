<%@ Page Language="C#" MasterPageFile="~/Usermaster.master" AutoEventWireup="true"
    CodeFile="Tariff.aspx.cs" Inherits="Tariff" EnableEventValidation="false" %>
            ...
            <div class="text-holder">
                ...
                <p id="pyear" runat="server" visible="false">
                    <label for="<%=drpyear.ClientID %>">
                        Select for Distribution &amp; Retail Supply:</label>
        ...
        <div class="left-nav-holder">
            ...
            <div class="left-nav-btn">
                <ul>
                    ...
                    <li><a class="current" href="~/Tariff/360_1_DistributionCharges.aspx" title=" Distribution Charges" id="current"
                        runat="server">
                    ...
                    <li><a class="current" href="~/content/Hindi/Tariff/369_1_DistributionCharges.aspx"
                        title=" Distribution Charges" id="A8" runat="server">
                        <%=Resources.HercResource.DistributionCharges %></a></li>
                    <li><a href="~/content/Hindi/Crosssubsidy/779_1_Crosssubsidy.aspx" title="Cross subsidy"
                        id="A9" runat="server">
                        <%=Resources.HercResource.Cross %>
                    </a></li>
                    <li><a href="~/content/Hindi/RenewalEnergy/780_1_RenewalEnergy.aspx" title="Renewal Energy "
                        id="A10" runat="server">
                        <%=Resources.HercResource.Renewal %>
                    </a></li>
                    <%} %>
