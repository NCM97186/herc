<%@ Page Language="C#" MasterPageFile="~/Usermaster.master" AutoEventWireup="true"
    CodeFile="Codes.aspx.cs" Inherits="Codes" %>
            ...
            <div class="left-nav-btn">
                <ul>
                    <% if (Convert.ToInt16(Resources.HercResource.Lang_Id) == Convert.ToInt16(Module_ID_Enum.Language_ID.English))
                       { %>
                    <li><a href="~/Codes/1.aspx" id="herc" runat="server">
                        <%=Resources.HercResource.herc %></a></li>
                    <li><a href="~/content/195_3_Others.aspx" id="other" runat="server">
                        <%=Resources.HercResource.Others %></a></li>
                    <li><a href="~/Codes/8.aspx" id="repealed" runat="server">
                        <%=Resources.HercResource.RepealedCodes %></a></li>
                    <% }

                       else
                       { %>
                    <li><a href="~/content/Hindi/Codes/1.aspx" id="hercHindi" runat="server">
                        <%=Resources.HercResource.herc %></a></li>
                    <li><a href="~/content/Hindi/207_3_Others.aspx" id="otherHindi" runat="server">
                        <%=Resources.HercResource.Others %></a></li>
                    <li><a href="~/content/Hindi/Codes/8.aspx" id="repealedHindi" runat="server">
                        <%=Resources.HercResource.RepealedCodes%></a></li>
                    <%} %>
                </ul>
            </div>
            ...
            <div class="text-holder">
                ...
                <div>
                    <asp:GridView ID="gvRegulations" OnRowDataBound="gvRegulations_RowDataBound" Width="100%"
                        ...
                        UseAccessibleHeader="true" DataKeyNames="Link_Id" ToolTip="Codes" summary="This table show all HERC codes">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Regulation No." HeaderStyle-CssClass="Text-Center"
                                Visible="false">
                                <ItemTemplate>
                                    <asp:Label ID="lblRegulationNo" runat="server" Text='<%#Eval("RegulationNo") %>'></asp:Label>
                            ...
                            <asp:TemplateField HeaderText="Download" ItemStyle-CssClass="Text-Center" HeaderStyle-CssClass="Text-Center"
                                ...
                                <ItemTemplate>
                                    <asp:LinkButton ID="LinkButton1" CommandName="view" CommandArgument='<%#Eval("File_Name")%>'
                                        runat="server"> <img src='<%=ResolveUrl("~/images/pdf_button.png")%>' title="View Document" width="20" alt="View Document"
