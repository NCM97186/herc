    ...
    <asp:Panel ID="pnlGrid" runat="server">
        ...
        <p>
            <asp:GridView ID="grdOrderPdf" runat="server" Visible="false" AutoGenerateColumns="false"
                OnRowDataBound="grdOrderPdf_RowDataBound" DataKeyNames="Temp_Petition_Id" ToolTip="Petition" summary="This table show all petitions">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="PRO No" SortExpression="pro1" ItemStyle-CssClass="Text-Center"
            ...
            <asp:GridView ID="grdPetition" runat="server" AutoGenerateColumns="false" DataKeyNames="Temp_Petition_Id"
                ...
                <Columns>
                    ...
                    <asp:TemplateField ItemStyle-CssClass="Text-Center" HeaderStyle-CssClass="Text-Center">
                        ...
                        <ItemTemplate>
                            <a href="Petition_Add_Edit.aspx?Petition_Id=<%#DataBinder.Eval(Container.DataItem,"Temp_Petition_Id")%> &ModuleID= <%=Convert.ToInt16( Module_ID_Enum.Project_Module_ID.Petition) %>&LangID=<%#DataBinder.Eval(Container.DataItem,"Lang_Id")%>">
        ...
        <table width="100%">
            <tr>
                <td valign="top">
                    ...
                    <asp:CustomValidator runat="server" ForeColor="Red" ID="CustomValidator1" ClientValidationFunction="ValidateColorList"
            ...
            <tr>
                <td align="center">
                    ...
                    <asp:Button ID="btnCancelEmailDis" runat="server" CssClass="button" 
                        Text="Cancel" onclick="btnCancelEmailDis_Click" />
                </td>
            </tr>
        </table>
    </asp:Panel>
