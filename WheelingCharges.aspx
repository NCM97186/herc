<%@ Page Language="C#" MasterPageFile="~/Usermaster.master" AutoEventWireup="true"
    CodeFile="WheelingCharges.aspx.cs" Inherits="WheelingCharges" %>
        ...
        <div class="working-content-holder">
            <div class="page-had">
                ...
                <div class="page-had-mid-side">
                    <h2>
                        <%=Resources.HercResource.WheelingCharges %></h2>
            ...
            <div class="text-holder">
                ...
                <p id="pyear" runat="server" visible="false">
                    <label for="<%=drpyear.ClientID %>">
                        Select for Wheeling - Distribution System:</label>
        ...
        <div class="left-nav-holder">
            ...
            <div class="left-nav-btn">
                <ul>
                    ...
                    <li><a class="current" href="~/WheelingCharges/363_1_WheelingCharges.aspx" title="Wheeling Charges" id="A2"
                        runat="server">
                    ...
                    <li><a class="current" href="~/content/Hindi/WheelingCharges/372_1_WheelingCharges.aspx"
                        title="Wheeling Charges" id="A7" runat="server">
                        <%=Resources.HercResource.WheelingCharges %>
                    </a></li>
