<%@ Page Language="C#" MasterPageFile="~/OmbudsmanMaster.master" AutoEventWireup="true"
    CodeFile="ProfilePrevious.aspx.cs" Inherits="Ombudsman_ProfilePrevious" %>
        ...
        <div class="working-content-holder">
            <div class="page-had">
                ...
                <div class="page-had-mid-side">
                    <h2>
                        <%=Resources.HercResource.Profileprev %></h2>
            ...
            <div class="text-holder">
                <p style="text-align: right;">
                    <asp:LinkButton ID="LnkViewcurrent" runat="server" OnClick="LnkViewcurrent_Click"><%=Resources.HercResource.profileofCurrentOmbudsmenMembers%></asp:LinkButton>
                </p>
                <asp:GridView ID="grdCMSMenu" runat="server" AutoGenerateColumns="False" DataKeyNames="Profile_Id"
                    Width="100%" OnRowDataBound="grdCMSMenu_RowDataBound" ToolTip="Profiles" summary="This table show all previous year profiles records">
