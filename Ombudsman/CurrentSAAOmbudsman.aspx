<%@ Page Language="C#" MasterPageFile="~/OmbudsmanMaster.master" AutoEventWireup="true"
    CodeFile="CurrentSAAOmbudsman.aspx.cs" Inherits="Ombudsman_CurrentSAA" Title="" %>
        ...
        <div class="working-content-holder">
            <div class="page-had">
                ...
                <div class="page-had-mid-side">
                    <h2>
                        <%=Resources.HercResource.CurrentYearApplicationsSAA%></h2>
            ...
            <div class="text-holder">
                ...
                <asp:GridView ID="grdFAA_SAA_RTI" runat="server" Width="100%" AutoGenerateColumns="false"
                    OnRowDataBound="grdFAA_SAA_RTI_RowDataBound" OnRowCommand="grdrtifAA_RowCommand" ToolTip="Current Year Applications- SAA" summary="This table show all the current year application SAA">
                    <Columns>
                        <asp:TemplateField HeaderText="SIC Ref No" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
