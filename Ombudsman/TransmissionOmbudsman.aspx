<%@ Page Language="C#" MasterPageFile="~/OmbudsmanMaster.master" AutoEventWireup="true" CodeFile="TransmissionOmbudsman.aspx.cs"
 Inherits="Ombudsman_TransmissionOmbudsman"%>
        ...
        <div class="left-nav-holder">
            ...
            <div class="left-nav-btn">
                <ul>
                    ...
                    <li><a  class="current" href="~/Ombudsman/TransmissionOmbudsman.aspx" title="Transmission Charges" id="previous"
                        runat="server">
                    ...
                    <li><a href="~/Ombudsman/DistributionOmbudsman.aspx" title="Distribution Charges" id="current" runat="server">
