<%@ Page Language="C#" MasterPageFile="~/OmbudsmanMaster.master" AutoEventWireup="true"
    CodeFile="PreviousFAAOmbudsman.aspx.cs" Inherits="Ombudsman_PreviousFAAOmbudsman"
    Title="" %>
            ...
            <div class="text-holder">
                ...
                <div id="DRti" runat="server" class="RTI_link2">
                    <ul>
                        ...
                        <li>
                            <asp:LinkButton ID="lnkSAA" runat="server" OnClick="lnkSAA_click">View Previous Years SAA Applications</asp:LinkButton>
                        </li>
                    </ul>
                </div>
                <br />
                ...
                <asp:GridView ID="grdrtifAA" runat="server" Width="100%" AutoGenerateColumns="false"
                    OnRowDataBound="grdrtifAA_RowDataBound" OnRowCommand="grdrtifAA_RowCommand" GridLines="None" ToolTip="Previous Years Applications- FAA" summary="This table show all the previous year application FAA.">
                    <Columns>
