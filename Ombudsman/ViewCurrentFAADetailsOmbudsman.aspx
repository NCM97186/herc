<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewCurrentFAADetailsOmbudsman.aspx.cs"
    Inherits="Ombudsman_ViewCurrentFAADetailsOmbudsman" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>View Current FAA Details</title>
    ...
    <div>
        <asp:Panel ID="PGridDetails" runat="server">
            <asp:GridView ID="GvCurrentRTI" DataKeyNames="Temp_RTI_Id" runat="server" Width="90%"
                ...
                OnRowCommand="GvCurrentRTI_RowCommand" GridLines="None" CssClass="more_details"
                Caption="RTI DETAILS" ToolTip="RTI" summary="This table show all RTI records">
                <EmptyDataTemplate>
                    No Record Found
                </EmptyDataTemplate>
                <Columns>
        ...
        <asp:Panel ID="pPetitionGridDetatils" runat="server">
            <asp:GridView ID="grdrtifAA" runat="server" Width="90%" AutoGenerateColumns="false"
                OnRowDataBound="grdrtifAA_RowDataBound" OnRowCommand="grdrtifAA_RowCommand" GridLines="None"
                CssClass="more_details" Caption="RTI-FAA DETAILS" ToolTip="RTI-FAA" summary="This table show all RTI-FAA records">
                <Columns>
        ...
        <asp:GridView ID="grdFAA_SAA_RTI" runat="server" Width="90%" AutoGenerateColumns="false"
            ...
            GridLines="None" CssClass="more_details" Caption="RTI-SAA DETAILS" ToolTip="RTI-SAA" summary="This table show all RTI-SAA records">
            <Columns>
                <asp:TemplateField HeaderText="Ref No" Visible="false">
                    <ItemTemplate>
