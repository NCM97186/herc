<%@ Page Language="C#" MasterPageFile="~/OmbudsmanMaster.master" AutoEventWireup="true" CodeFile="GenerationOmbudsman.aspx.cs" 
Inherits="Ombudsman_GenerationOmbudsman"  %>
    ...
    <div class="left-holder">
        <div class="left-nav-holder">
            ...
            <div class="left-nav-btn">
                <ul>
                    <li><a class="current" href="~/Ombudsman/GenerationOmbudsman.aspx" title="Generation Tariff" id="A1"
                        runat="server">
