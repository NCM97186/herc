<%@ Page Language="C#" MasterPageFile="~/OmbudsmanMaster.master" AutoEventWireup="true" CodeFile="WheelingOmbudsman.aspx.cs"
 Inherits="Ombudsman_WheelingOmbudsman"  %>
            ...
            <div class="left-nav-btn">
                <ul>
                  <li><a  href="~/Ombudsman/GenerationOmbudsman.aspx" title="Generation Tariff" id="A1"
                    ...
                    <li><a class="current" href="~/Ombudsman/WheelingOmbudsman.aspx" title="Wheeling Charges" id="A2" runat="server">
