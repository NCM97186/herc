<%@ Page Language="C#" MasterPageFile="~/OmbudsmanMaster.master" AutoEventWireup="true"
    CodeFile="PreviousSAAOmbudsman.aspx.cs" Inherits="Ombudsman_PreviousSAAOmbudsman" %>
            ...
            <div class="text-holder">
                ...
                <div id="DRti" runat="server" class="RTI_link2">
                    <ul>
                        ...
                        <li>
                            <asp:LinkButton ID="lnkFAA" runat="server" OnClick="lnkFAA_click">View Previous Years FAA Applications</asp:LinkButton>
                        </li>
                    </ul>
                </div>
                <br />
                ...
                <asp:GridView ID="grdFAA_SAA_RTI" runat="server" Width="100%" AutoGenerateColumns="false"
                    ...
                    GridLines="None" ToolTip="Previous Years Applications- SAA" summary="This table show all previous year applications- SAA">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="FAA Ref No" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:LinkButton ID="lblSAArefno1" runat="server" Text='<%#Eval("FaarefNo") %>' CommandName="View"
                                    CommandArgument='<%# DataBinder.Eval(Container.DataItem, "RTI_SAA_Id") %>' ToolTip='<%#Resources.HercResource.ClickHereToViewDetails %>'></asp:LinkButton>
                        ...
                        <asp:TemplateField HeaderText="Status">
                            <ItemTemplate>
                                <%--<asp:Label ID="lblSAAstatus" runat="server" Text='<%#Eval("statusName") %>' />--%>
                                <asp:Label ID="lblSAAstatus" runat="server" Text='<%#Miscelleneous_DL.FixCharacters(DataBinder.Eval(Container.DataItem,"statusName"),100) %>'></asp:Label>
