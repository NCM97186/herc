<%@ Page Language="C#" MasterPageFile="~/OmbudsmanMaster.master" AutoEventWireup="true" CodeFile="ReportsDetails.aspx.cs" Inherits="Ombudsman_ReportsDetails"  %>
    ...
    <div class="right-holder">
        <div class="working-content-holder">
            ...
            <div class="text-holder">
                ...
                <asp:Literal ID="ltrlPdf" runat="server" Visible="false"> </asp:Literal>
                <asp:Literal ID="lrtTariff" runat="server" Text='<%# Eval("Details") %>'> </asp:Literal>
                <p>
        ...
        <div class="left-nav-holder">
            <div class="left-nav-had">
                <div class="left-nav-mid">
                  ...
                  <%=Resources.HercResource.Reports %>
                    </h2>
                </div>
            </div>
            <div class="clear">
