...
(function(){function a(e,f)
{
    var g=f.block||f.blockLimit;
    if(!g||g.getName()=='body')
    return CKEDITOR.TRISTATE_OFF;
    if(g.getAscendant('blockquote',true))
...
function c(e)
{
    for(var f=0,g=e.getChildCount(),h;f<g&&(h=e.getChild(f));f++)
...
var d={exec:function(e)
{
    ...
    if(CKEDITOR.env.ie){var j=i[0].startNode,k=i[0].endNode,l;if(j&&j.getParent().getName()=='blockquote')
    {
        l=j;
        while(l=l.getNext())
...
if(f==CKEDITOR.TRISTATE_OFF){var o=[];
