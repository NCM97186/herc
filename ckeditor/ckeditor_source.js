...
{
    var a={timestamp:'',version:'3.1',revision:'4891',_:{},status:'unloaded',basePath:(function()
    {
        var d=window.CKEDITOR_BASEPATH||'';if(!d){var e=document.getElementsByTagName('script');
