<%@ Page Language="C#" MasterPageFile="~/Usermaster.master" AutoEventWireup="true"
    CodeFile="CurrentFAA.aspx.cs" Inherits="CurrentFAA" Title="" %>

<%@ Register Src="UserControl/RTI_Control.ascx" TagName="RTI_Control" TagPrefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <%--  <script type="text/javascript" language="javascript">

window.open ('ViewCurrentFAADetails.aspx', 'newwindow', config='height=100,
width=400, toolbar=no, menubar=no, scrollbars=no, resizable=Yes,
        ...
        <div class="working-content-holder">
            ...
            <div class="text-holder">
                ...
                <asp:GridView ID="grdrtifAA" runat="server" Width="100%" AutoGenerateColumns="false"
                    OnRowDataBound="grdrtifAA_RowDataBound" OnRowCommand="grdrtifAA_RowCommand" ToolTip='<%#Resources.HercResource.CurrentYearApplicationsFAA %>' summary="This table show all the current RTI-FAA records">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Appeal To SAA" ItemStyle-CssClass="Text-Center" Visible="false">
                            <ItemTemplate>
