<%@ Page Language="C#" MasterPageFile="~/Usermaster.master" AutoEventWireup="true"
    CodeFile="TransmissionCharges.aspx.cs" Inherits="TransmissionCharges" %>
        ...
        <div class="working-content-holder">
            <div class="page-had">
                ...
                <div class="page-had-mid-side">
                    <h2>
                        <%=Resources.HercResource.TransmissionCharges %></h2>
                    <div class="page-had-right-side">
                        ...
                        <div id="DlastUpdate" runat="server" class="last-updated">
                            <strong><%=Resources.HercResource.LastUpdated %>:</strong> <%=lastUpdatedDate %>
                        </div>
                    </div>
                </div>
            ...
            <div class="left-nav-btn">
                <ul>
                 <% if (Convert.ToInt16(Resources.HercResource.Lang_Id) == Convert.ToInt16(Module_ID_Enum.Language_ID.English))
                    ...
                    <li><a class="current" href="~/TransmissionCharges/361_1_TransmissionCharges.aspx" title="Transmission Charges"
                        id="previous" runat="server">
                    ...
                    <li><a href="~/Crosssubsidy/530_1_CrosssubsidyandAdditionalSurcharge.aspx" title="Cross subsidy" id="A4" runat="server">
                        <%=Resources.HercResource.Cross %>
                    </a></li>
                    <li><a  href="~/RenewalEnergy/532_1_CrosssubsidyandAdditionalSurcharge.aspx" title="Renewal Energy " id="A3"
                        runat="server">
                     ...
                     <% }
                       ...
                       { %>
                        <li><a href="~/content/Hindi/GenerationTariff/371_1_GenerationTariff.aspx" title="Generation Tariff" id="A5" runat="server">
                        <%=Resources.HercResource.GenerationTariff %></a></li>
                    <li><a class="current" href="~/content/Hindi/TransmissionCharges/370_1_TransmissionCharges.aspx" title="Transmission Charges"
                        id="A6" runat="server">
                        <%=Resources.HercResource.TransmissionCharges %>
                    </a></li>
                    <li><a href="~/content/Hindi/WheelingCharges/372_1_WheelingCharges.aspx" title="Wheeling Charges" id="A7" runat="server">
                        <%=Resources.HercResource.WheelingCharges %>
                    </a></li>
                    <li><a href="~/content/Hindi/Tariff/369_1_DistributionCharges.aspx" title=" Distribution Charges" id="A8" runat="server">
                        <%=Resources.HercResource.DistributionCharges %></a></li>
                    <li><a  href="~/content/Hindi/Crosssubsidy/806_1_Crosssubsidy.aspx" title="Cross subsidy" id="A9" runat="server">
                        <%=Resources.HercResource.Cross %>
                    </a></li>
                    <li><a  href="~/content/Hindi/RenewalEnergy/807_1_RenewalEnergy.aspx" title="Renewal Energy " id="A10" runat="server">
                        <%=Resources.HercResource.Renewal %>
                    </a></li>
