<%@ Page Language="C#" MasterPageFile="~/Usermaster.master" AutoEventWireup="true"
    CodeFile="CurrentSAA.aspx.cs" Inherits="CurrentSAA" Title="" %>
        ...
        <div class="working-content-holder">
            ...
            <div class="text-holder">
                ...
                <asp:GridView ID="grdFAA_SAA_RTI" runat="server" Width="100%" AutoGenerateColumns="false"
                    OnRowDataBound="grdFAA_SAA_RTI_RowDataBound" OnRowCommand="grdrtifAA_RowCommand" ToolTip='<%#Resources.HercResource.CurrentYearApplicationsSAA %>' summary="This table shows all the current RTI SAA records">
                    <Columns>
                       <asp:TemplateField HeaderText="SIC Ref No" ItemStyle-CssClass="Text-Center" HeaderStyle-CssClass="Text-Center">
                        ...
                        <%--<asp:BoundField HeaderText="Status" DataField="RTI_SAA_StatusId" />--%>
