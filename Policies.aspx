<%@ Page Language="C#" MasterPageFile="~/Usermaster.master" AutoEventWireup="true"
    CodeFile="Policies.aspx.cs" Inherits="Policies" %>
        ...
        <div class="left-nav-holder">
            <div class="left-nav-had">
                <div class="left-nav-mid">
                    <h2>
                        <%=Resources.HercResource.Policies%>
                    </h2>
                </div>
            </div>
            <div class="clear">
            ...
            <div class="left-nav-btn">
                <ul>
                    <% if (Convert.ToInt16(Resources.HercResource.Lang_Id) == Convert.ToInt16(Module_ID_Enum.Language_ID.English))
                       { %>
                    <li><a href="~/Policies/1.aspx" id="herc" runat="server">
                        <%=Resources.HercResource.herc %></a></li>
                    <li><a href="~/content/119_1_Others.aspx" id="other" runat="server">
                        <%=Resources.HercResource.Others %></a></li>
                    <li><a href="~/Policies/8.aspx" id="repealed" runat="server">
                        <%=Resources.HercResource.RepealedPolicies %></a></li>
                    <% }

                       else
                       { %>
                    <li><a href="~/content/Hindi/Policies/1.aspx" id="herc_Hindi" runat="server">
                        <%=Resources.HercResource.herc %></a></li>
                    <li><a href="~/content/Hindi/163_1_Others.aspx" id="other_Hindi" runat="server">
                        <%=Resources.HercResource.Others %></a></li>
                    <li><a href="~/content/Hindi/Policies/8.aspx" id="repealed_Hindi" runat="server">
                        <%=Resources.HercResource.RepealedPolicies %></a></li>
                    <%} %>
                </ul>
            </div>
            ...
            <div class="text-holder">
                ...
                <div>
                    <asp:GridView ID="gvRegulations" OnRowDataBound="gvRegulations_RowDataBound" Width="100%"
                        ...
                        UseAccessibleHeader="true" DataKeyNames="Link_Id" CssClass="more_details" ToolTip="Policies" summary="This table show all policies of HERC">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Description" HeaderStyle-CssClass="Text-Center">
                                <ItemTemplate>
                                    <asp:HyperLink ID="hypFile" runat="server" Text='<%# Server.HtmlDecode((string)Eval("Name"))%>'
                                        ...
                                        ToolTip="View Document"></asp:HyperLink>
                            ...
                            <asp:TemplateField HeaderText="Policy No." ItemStyle-HorizontalAlign="Center" Visible="false">
                                <ItemTemplate>
                    ...
                    <%--  <asp:Literal ID="LtrRegulation" runat="server">    
                    </asp:Literal>--%>
                </div>
                <br />
