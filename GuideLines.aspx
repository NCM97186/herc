<%@ Page Language="C#" MasterPageFile="~/Usermaster.master" AutoEventWireup="true"
    CodeFile="GuideLines.aspx.cs" Inherits="GuideLines" %>
        ...
        <div class="left-nav-holder">
            <div class="left-nav-had">
                <div class="left-nav-mid">
                    <h2>
                        <%=Resources.HercResource.Guidelines%>
                    </h2>
                </div>
            </div>
            <div class="clear">
            ...
            <div class="left-nav-btn">
                <ul>
                    <% if (Convert.ToInt16(Resources.HercResource.Lang_Id) == Convert.ToInt16(Module_ID_Enum.Language_ID.English))
                       { %>
                    <li><a href="~/GuideLines/1.aspx" id="herc" runat="server">
                        <%=Resources.HercResource.herc %></a></li>
                    <li><a href="~/content/122_1_Others.aspx" id="other" runat="server">
                        <%=Resources.HercResource.Others %></a></li>
                    <li><a href="~/GuideLines/8.aspx" id="repealed" runat="server">
                        <%=Resources.HercResource.RepealedGuidelines %></a></li>
                    <% }

                       else
                       { %>
                    <li><a href="~/content/Hindi/GuideLines/1.aspx" id="herc_Hindi" runat="server">
                        <%=Resources.HercResource.herc %></a></li>
                    <li><a href="~/content/Hindi/166_1_Others.aspx" id="other_Hindi" runat="server">
                        <%=Resources.HercResource.Others %></a></li>
                    <li><a href="~/content/Hindi/GuideLines/8.aspx" id="repealed_Hindi" runat="server">
                        <%=Resources.HercResource.RepealedGuidelines %></a></li>
                    <%} %>
                </ul>
            </div>
            ...
            <div class="text-holder">
                ...
                <div>
                    <asp:GridView ID="gvRegulations" OnRowDataBound="gvRegulations_RowDataBound" Width="100%"
                        ...
                        UseAccessibleHeader="true" DataKeyNames="Link_Id" CssClass="more_details" ToolTip="Guidelines" summary="This table show all guidelines">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Guideline No." Visible="false">
                                <ItemTemplate>
