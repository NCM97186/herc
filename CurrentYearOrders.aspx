<%@ Page Language="C#" MasterPageFile="~/Usermaster.master" AutoEventWireup="true"
    CodeFile="CurrentYearOrders.aspx.cs" Inherits="CurrentYearOrders" %>
        ...
        <div class="working-content-holder">
            ...
            <div class="text-holder">
                ...
                <label for="<%=drpyear.ClientID %>">
                    Select for Previous Years Orders:</label>
                ...
                <asp:GridView ID="gvDailyOrders" runat="server" AutoGenerateColumns="false" UseAccessibleHeader="true"
                    ...
                    Width="100%" DataKeyNames="OrderId" ToolTip="Order details" summary="This table show all type of orders">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Petitioner(s)">
                            <ItemTemplate>
                                <asp:Label ID="lblPetitioner" runat="server" Text='<%# Miscelleneous_DL.FixCharacters(DataBinder.Eval(Container.DataItem,"Petitioner_Name"),97) %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
