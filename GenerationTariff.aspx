<%@ Page Language="C#" MasterPageFile="~/Usermaster.master" AutoEventWireup="true"
    CodeFile="GenerationTariff.aspx.cs" Inherits="GenerationTariff" %>
        ...
        <div class="working-content-holder">
            <div class="page-had">
                ...
                <div class="page-had-mid-side">
                    <h2>
                        <%=Resources.HercResource.GenerationTariff %></h2>
            ...
            <div class="text-holder">
                ...
                <p id="pyear" runat="server" visible="false">
                    <label for="<%=drpyear.ClientID %>">
                        Select for Generation Tariff:</label>
            ...
            <div class="left-nav-btn">
                <ul>
                    <% if (Convert.ToInt16(Resources.HercResource.Lang_Id) == Convert.ToInt16(Module_ID_Enum.Language_ID.English))
                       { %>
                    <li><a class="current" href="~/GenerationTariff/362_1_GenerationTariff.aspx" title="Generation Tariff" id="A1"
                        runat="server">
                    ...
                    <% }
                       ...
                       { %>
                    <li><a class="current" href="~/content/Hindi/GenerationTariff/371_1_GenerationTariff.aspx"
                        title="Generation Tariff" id="A5" runat="server">
                        <%=Resources.HercResource.GenerationTariff %></a></li>
                    ...
                    <li><a href="~/content/Hindi/Tariff/369_1_DistributionCharges.aspx" title=" Distribution Charges"
                        id="A8" runat="server">
                        <%=Resources.HercResource.DistributionCharges %></a></li>
                    <li><a href="~/content/Hindi/Crosssubsidy/806_1_Crosssubsidy.aspx" title="Cross subsidy"
                        id="A9" runat="server">
                        <%=Resources.HercResource.Cross %>
                    </a></li>
